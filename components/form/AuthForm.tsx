...
const AuthForm = <T extends FieldValues>({
  ...
  return (
    <Form {...form}>
         ...
         {formType === "SIGN_IN" ? <p>Don{"'"}t have an account? <Link href={routes.signUp} className="paragraph-semibold primary-text-gradient">Sign In</Link></p> : <p>Already have an account? <Link href={routes.login} className="paragraph-semibold primary-text-gradient">Sign In</Link></p>}
         </form>
     </Form>
  );
};
